//
//  BSSExtensionUIApplication.swift
//  IOSToolBox
//
...
extension UIApplication {
    /** 跳转应用设置 */
    public static func bcpushapplicationsetting(completionHandler: ((Bool) -> Void)? = nil) {
