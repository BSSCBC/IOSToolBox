...
extension String {
    ...
    /** 
     富文本
        特定文字高亮
     **/
    public func bchighLight(normalColor: UIColor, hightLightText: String, hightLightColor: UIColor) -> NSAttributedString {
    ...
    public func bclineSpacing(lineSpacing: CGFloat) -> NSAttributedString {
...
extension NSAttributedString {
    ...
    /** 富文本 修改行间距 **/
    public func bcfont(font: UIFont) -> NSAttributedString {
    ...
    /** 富文本 修改颜色 **/
    public func bcadd(textColor: UIColor) -> NSAttributedString {
...
extension String {
    /** 截取字符串 */
    public func bctruncatestring(toLength length: Int) -> String {
...
extension String {
    /** 将字符串转为*号
     ...
     length表示长度
     */
    public func bcmaskcharacters(start: Int, length: Int) -> String {
